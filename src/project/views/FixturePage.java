...
public class FixturePage extends Page{
	...
	public FixturePage(ArrayList<Season> seasons,Club club,Federation federation) {
	...
	public void buildPage() {
		...
		if(i >= seasons.size()) {
			...
			if(choice == 0) {
				FixturePage fp=new FixturePage(seasons,club,federation);
				fp.buildPage();
			}
			else {
				TeamInfoPage tp=new TeamInfoPage(club,federation);
				tp.buildPage();
			}
		}
		else {
